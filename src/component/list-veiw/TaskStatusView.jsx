...
export default function TaskStatusView({ StatusTasks, status , text }) {
    return (
        <>
            <div 
                className="px-5 w-full h-12 bg-stone-200 dark:bg-[#262626] flex items-center text-md font-semibold text-stone-600 dark:text-[#a3a3a3] border-b
                border-gray-300 dark:border-[#3a3a3a] overflow-x-auto"
            >
                <p>{status}</p>
            </div>
